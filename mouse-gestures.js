...
function initMouseGestures(ipcRenderer) {
  ...
  const gestureActions = {
    'L': { name: 'Go Back', icon: '<svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5"><polyline points="15 18 9 12 15 6"/></svg>', action: () => ipcRenderer.send('trigger-action', 'go-back') },
    'R': { name: 'Go Forward', icon: '<svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5"><polyline points="9 18 15 12 9 6"/></svg>', action: () => ipcRenderer.send('trigger-action', 'go-forward') },
    ...
    'D': { name: 'Scroll to Bottom', icon: '<svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5"><polyline points="6 9 12 15 18 9"/></svg>', action: () => window.scrollTo({ top: document.body ? document.body.scrollHeight : 5000, behavior: 'smooth' }) },
    'UD': { name: 'Reload Page', icon: '<svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5"><polyline points="23 4 23 10 17 10"/><path d="M20.49 15a9 9 0 1 1-2.12-9.36L23 10"/></svg>', action: () => ipcRenderer.send('trigger-action', 'reload') },
